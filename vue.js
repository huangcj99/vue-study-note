...
function stateMixin (Vue) {
  ...
  // console.log(Vue.prototype.$data);console.log(dataDef);console.log('------')
...
function normalizeChildren (
  ...
  if (Array.isArray(children)) {
    ...
    // console.log('----------normalizeChildren');console.log(children);console.log(res);
    return res
  }
}
...
function _createElement (
  ...
  if (typeof tag === 'string') {
    ...
    // console.log('---------config');console.log(config.isReservedTag);
